...
using Mvc_ConfirmarEmail.Models;
using Mvc_ConfirmarEmail.Servicos;

namespace Mvc_ConfirmarEmail.Controllers
{
    [Authorize]
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //---------------------------------------------------------------inicio
                    ViewBag.Message = "Verique o seu email e confirme sua conta, Você tem que confirmar a sua conta clicando no link antes de fazer o login";
                    return View("Info");
                   //-------------------------------------------------------------------fim
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string code = await UserManager.GeneratePasswordResetTokenAsync(user.Id);
                var callbackUrl = Url.Action("ResetPassword", "Account", new { userId = user.Id, code = code }, protocol: Request.Url.Scheme );
                await ServicoEmail.EnviaEmailAsync(model.Email, "Resetar a senha", "Resete sua senha clicando <a href=\"" + callbackUrl + "\">Aqui</a>");
                return RedirectToAction("ForgotPasswordConfirmation", "Account");
            }
